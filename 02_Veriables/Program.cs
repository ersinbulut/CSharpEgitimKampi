...
namespace _02_Veriables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //ABC12D
            //int shoesPrice, compoterPrice, chairPrice, tvPrice;
            //shoesPrice = 1000;
            //compoterPrice = 20000;
            //chairPrice = 5000;
            //tvPrice = 12000;

            //int shoesCount, compoterCount, chairCount, tvCount;

            //Console.Write("Lütfen aldığınız ayakkabı sayısını giriniz:");
            //shoesCount=int.Parse(Console.ReadLine());

            //Console.Write("Lütfen aldığınız bilgisayar sayısını giriniz:");
            //compoterCount = int.Parse(Console.ReadLine());
            ...
            //int totalPrice=shoesCount*shoesPrice+compoterCount*compoterPrice+chairCount*chairPrice+tvCount*tvPrice;
            //Console.WriteLine();
